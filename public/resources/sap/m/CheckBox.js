...
sap.m.CheckBox.prototype.setSelected=function(s){s=!!s;if(s==this.getSelected()){return this}jQuery.sap.byId(this.getId()+'-CbBg').toggleClass("sapMCbMarkChecked",s);var c=jQuery.sap.domById(this.getId()+'-CB');if(c){s?c.setAttribute('checked','checked'):c.removeAttribute('checked')}this.setProperty("selected",s,true);return this};
