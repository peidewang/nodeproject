...
sap.m.SwitchRenderer._renderHandle=function(r,s,S,d){r.write("<div");r.addClass("sapMSwtHandle");if(sap.ui.Device.browser.webkit&&Number(jQuery.browser.version).toFixed(2)==="537.35"){r.addClass("sapMSwtWebKit537-35")}r.writeClasses();if(!d){r.writeAttribute("tabindex","0")}r.writeAttributeEscaped("data-sap-ui-swt",S);r.write(">");r.write("</div>")};
