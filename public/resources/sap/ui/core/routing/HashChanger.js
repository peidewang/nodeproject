...
jQuery.sap.declare("sap.ui.core.routing.HashChanger");jQuery.sap.require("sap.ui.base.EventProvider");jQuery.sap.require("sap.ui.thirdparty.signals");jQuery.sap.require("sap.ui.thirdparty.hasher");sap.ui.base.EventProvider.extend("sap.ui.core.routing.HashChanger",{constructor:function(){sap.ui.base.EventProvider.apply(this)}});
sap.ui.core.routing.HashChanger.prototype.init=function(){if(this._initialized){jQuery.sap.log.info("this HashChanger instance has already been initialized.");return false}hasher.changed.add(this.fireHashChanged,this);if(!hasher.isActive()){hasher.initialized.addOnce(this.fireHashChanged,this);hasher.init()}else{this.fireHashChanged(hasher.getHash())}this._initialized=true;return this._initialized};
...
sap.ui.core.routing.HashChanger.prototype.destroy=function(){hasher.changed.remove(this.fireHashChanged,this);sap.ui.base.EventProvider.prototype.destroy.apply(this,arguments)};
