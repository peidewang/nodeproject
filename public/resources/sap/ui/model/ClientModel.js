 ...
 */
jQuery.sap.declare("sap.ui.model.ClientModel");jQuery.sap.require("sap.ui.model.Model");jQuery.sap.require("sap.ui.model.ClientPropertyBinding");jQuery.sap.require("sap.ui.model.ClientContextBinding");jQuery.sap.require("sap.ui.model.ClientListBinding");jQuery.sap.require("sap.ui.model.ClientTreeBinding");sap.ui.model.Model.extend("sap.ui.model.ClientModel",{constructor:function(d){sap.ui.model.Model.apply(this,arguments);this.bCache=true;if(typeof d=="string"){this.loadData(d)}},metadata:{publicMethods:["loadData","setData","getData","setProperty","forceNoCache"]}});
...
sap.ui.model.ClientModel.prototype.bindContext=function(p,c,P){var b=new sap.ui.model.ClientContextBinding(this,p,c,P);return b};
