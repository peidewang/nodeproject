...
sap.ui.model.CompositeBinding.prototype.attachChange=function(f,l){this.attachEvent("change",f,l);if(this.aBindings){var t=this;jQuery.each(this.aBindings,function(i,b){b.attachChange(t.checkUpdate,t)})}};
sap.ui.model.CompositeBinding.prototype.detachChange=function(f,l){this.detachEvent("change",f,l);if(this.aBindings){var t=this;jQuery.each(this.aBindings,function(i,b){b.detachChange(t.checkUpdate,t)})}};
...
sap.ui.model.CompositeBinding.prototype.checkUpdate=function(f){var v=this.getExternalValue();if(!jQuery.sap.equal(v,this.oValue)||f){this.oValue=v;this._fireChange({reason:sap.ui.model.ChangeReason.Change})}};
