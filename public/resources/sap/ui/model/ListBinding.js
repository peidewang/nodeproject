...
sap.ui.model.ListBinding.prototype.attachSort=function(f,l){this.attachEvent("sort",f,l)};
sap.ui.model.ListBinding.prototype.detachSort=function(f,l){this.detachEvent("sort",f,l)};
sap.ui.model.ListBinding.prototype._fireSort=function(a){this.fireEvent("sort",a)};
sap.ui.model.ListBinding.prototype.attachFilter=function(f,l){this.attachEvent("filter",f,l)};
sap.ui.model.ListBinding.prototype.detachFilter=function(f,l){this.detachEvent("filter",f,l)};
sap.ui.model.ListBinding.prototype._fireFilter=function(a){this.fireEvent("filter",a)};
